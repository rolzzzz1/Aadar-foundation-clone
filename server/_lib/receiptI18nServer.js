/** Server mirror of src/utils/receiptI18n.js (receipt copy for PDF generation). */
...
function amountInWordsInrHi(amountInr) {
...
const RECEIPT_COPY = {
  ...
  hi: {
    ...
    donationRows: {
      ...
      modeOfTransaction: "लेनदेन का माध्यम",
    },
    taxNotice:
    ...
    signature: "यह कंप्यूटर जनित रसीद है और भौतिक हस्ताक्षर की आवश्यकता नहीं है।",
...
function getReceiptLocale(record) {
  return record && record.locale === "hi" ? "hi" : "en";
}

function getReceiptCopy(recordOrLocale) {
  const locale =

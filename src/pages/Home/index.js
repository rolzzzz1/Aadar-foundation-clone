    ...
    return (
      ...
      >
        ...
        <MKBox
          ...
          sx={{
            background:
              "linear-gradient(to bottom, #FFB300 0%, #FFC107 15%, #FFD54F 30%, #FFC107 45%, #FFB300 60%, #FFC107 75%, #FFD54F 90%, #FFC107 100%)",
            clipPath:
              "polygon(30% 0%, 70% 0%, 75% 2%, 65% 4%, 82% 6%, 58% 8%, 85% 10%, 62% 12%, 88% 14%, 65% 16%, 85% 18%, 62% 20%, 88% 22%, 65% 24%, 85% 26%, 62% 28%, 88% 30%, 65% 32%, 85% 34%, 62% 36%, 88% 38%, 65% 40%, 85% 42%, 62% 44%, 88% 46%, 65% 48%, 85% 50%, 62% 52%, 88% 54%, 65% 56%, 85% 58%, 62% 60%, 88% 62%, 65% 64%, 85% 66%, 62% 68%, 88% 70%, 65% 72%, 85% 74%, 62% 76%, 88% 78%, 65% 80%, 85% 82%, 62% 84%, 88% 86%, 65% 88%, 85% 90%, 62% 92%, 88% 94%, 65% 96%, 70% 100%, 30% 100%, 25% 98%, 35% 96%, 18% 94%, 42% 92%, 15% 90%, 38% 88%, 12% 86%, 35% 84%, 18% 82%, 42% 80%, 15% 78%, 35% 76%, 12% 74%, 38% 72%, 15% 70%, 35% 68%, 12% 66%, 38% 64%, 15% 62%, 35% 60%, 12% 58%, 38% 56%, 15% 54%, 35% 52%, 12% 50%, 38% 48%, 15% 46%, 35% 44%, 12% 42%, 38% 40%, 15% 38%, 35% 36%, 12% 34%, 38% 32%, 15% 30%, 35% 28%, 12% 26%, 38% 24%, 15% 22%, 35% 20%, 12% 18%, 38% 16%, 15% 14%, 35% 12%, 18% 10%, 30% 8%, 25% 6%, 35% 4%, 18% 2%, 30% 0%)",

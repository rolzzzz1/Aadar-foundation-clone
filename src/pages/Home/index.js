  ...
  if (slideIndex === 1) {
    return (
      ...
      >
        ...
        <MKBox
          position="absolute"
          left={{ xs: "calc(66.67% - 45px)", md: "calc(66.67% - 55px)" }}
          top={{ xs: "70px", md: "80px" }}
          ...
          sx={{
            background:
              "linear-gradient(to bottom, #D4942A 0%, #ECA533 25%, #F5C270 50%, #ECA533 75%, #D4942A 100%)",
            clipPath:
              "polygon(25% 0%, 75% 0%, 85% 5%, 70% 10%, 90% 15%, 65% 20%, 95% 25%, 60% 30%, 88% 35%, 55% 40%, 92% 45%, 50% 50%, 90% 55%, 55% 60%, 88% 65%, 60% 70%, 95% 75%, 65% 80%, 90% 85%, 70% 90%, 85% 95%, 75% 100%, 25% 100%, 15% 95%, 30% 90%, 10% 85%, 35% 80%, 5% 75%, 40% 70%, 12% 65%, 45% 60%, 8% 55%, 50% 50%, 10% 45%, 45% 40%, 12% 35%, 40% 30%, 5% 25%, 35% 20%, 10% 15%, 30% 10%, 15% 5%)",
